document.addEventListener("DOMContentLoaded", function(){
    ...
    firstNameInput.addEventListener("input", function (event) {
        ...
        // Message error
        MSEFirstName.classList.toggle("hidden", inputValue === "" || inputValue === null || isOnlyLetters);
    ...
    lastNameInput.addEventListener("input", function (event) {
        ...
        // Message error
        MSELastName.classList.toggle("hidden", inputValue === "" || inputValue === null || isOnlyLetters);
    });
    ...
    phoneInput.addEventListener('input', function (event) {
        ...
        // Message error
        MSEPhonenumber.classList.toggle("hidden", inputValue === "" || inputValue === null || isOnlyNumbers);
    });
    ...
    function validateConfirmPassword() {
        ...
        const isStrongPassword = /^(?=.*[A-Z])(?=.*[0-9!@#$%^&*])(.{10,})$/.test(confirmValue);
        ...
        // Message error
        MSECPassword.classList.toggle("hidden", confirmValue === "" || confirmValue === null || (confirm && confirmValue.length > 0));
    }
    ...
    btnSignUp.addEventListener('click', function(e) {
        ...
        if (!validateEmail(emailValue)) {
            showSuccessAlert();
            messageAlert.innerHTML = "Please enter a valid email address with a supported domain (gmail.com, yahoo.com, outlook.com).";
            return;
        }

        if (!ValidatePassword(passwordValue)) {
            showSuccessAlert();
            messageAlert.innerHTML = "Please enter a valid password (at least 10 characters, including an uppercase letter and a number or special character).";
            return;
        }

        if (passwordValue !== confirmPasswordValue) {
            showSuccessAlert();
            messageAlert.innerHTML = "Passwords do not match. Please re-enter your password.";
            return;
        }

        else{
            showSuccessAlert();
            messageAlert.innerHTML = "Passwords do not match. Please";
        }
    });
